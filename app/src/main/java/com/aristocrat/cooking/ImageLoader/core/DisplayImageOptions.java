...
import com.aristocrat.cooking.ImageLoader.core.assist.ImageScaleType;
import com.aristocrat.cooking.ImageLoader.core.display.BitmapDisplayer;
import com.aristocrat.cooking.ImageLoader.core.process.BitmapProcessor;

/**
 * Contains options for image display. Defines:
 * <ul>
 * <li>whether stub image will be displayed in {@link com.aristocrat.cooking.ImageLoader.core.imageaware.ImageAware
 ...
 * <li>whether {@link com.aristocrat.cooking.ImageLoader.core.imageaware.ImageAware image aware view} should be reset
 ...
 * <li>auxiliary object which will be passed to {@link com.aristocrat.cooking.ImageLoader.core.download.ImageDownloader#getStream(String, Object) ImageDownloader}</li>
 ...
 * <b>i.e.</b> :
 * <code>new {@link com.aristocrat.cooking.ImageLoader.core.DisplayImageOptions}.{@link Builder#Builder() Builder()}.{@link Builder#cacheInMemory() cacheInMemory()}.
...
public final class DisplayImageOptions {
	...
	/**
	 * Builder for {@link com.aristocrat.cooking.ImageLoader.core.DisplayImageOptions}
	 *
	 * @author Sergey Tarasevich (nostra13[at]gmail[dot]com)
	 */
	public static class Builder {
		...
		/**
		 * Stub image will be displayed in {@link com.aristocrat.cooking.ImageLoader.core.imageaware.ImageAware
		...
		/**
		 * Incoming image will be displayed in {@link com.aristocrat.cooking.ImageLoader.core.imageaware.ImageAware
		 * image aware view} during image loading
		 *
		...
		/**
		 * Incoming drawable will be displayed in {@link com.aristocrat.cooking.ImageLoader.core.imageaware.ImageAware
		 * image aware view} during image loading.
		 * This option will be ignored if {@link com.aristocrat.cooking.ImageLoader.core.DisplayImageOptions.Builder#showImageOnLoading(int)} is set.
		 */
		 ...
		 * image aware view} if empty URI (null or empty
		 * string) will be passed to <b>ImageLoader.displayImage(...)</b> method.
		 * This option will be ignored if {@link com.aristocrat.cooking.ImageLoader.core.DisplayImageOptions.Builder#showImageForEmptyUri(int)} is set.
		 */
		 ...
		 * image aware view} if some error occurs during
		 * requested image loading/decoding.
		 * This option will be ignored if {@link com.aristocrat.cooking.ImageLoader.core.DisplayImageOptions.Builder#showImageOnFail(int)} is set.
		 */
		...
		/**
		 * {@link com.aristocrat.cooking.ImageLoader.core.imageaware.ImageAware
		...
		/**
		 * Sets whether {@link com.aristocrat.cooking.ImageLoader.core.imageaware.ImageAware
		 * image aware view} will be reset (set <b>null</b>) before image loading start
		 */
		...
		/**
		 * Sets {@linkplain com.aristocrat.cooking.ImageLoader.core.assist.ImageScaleType scale type} for decoding image. This parameter is used while define scale
		 * size for decoding image to Bitmap. Default value - {@link com.aristocrat.cooking.ImageLoader.core.assist.ImageScaleType#IN_SAMPLE_POWER_OF_2}
		 */
		 ...
		 * calculate the most appropriate sample size itself according yo {@link #imageScaleType(com.aristocrat.cooking.ImageLoader.core.assist.ImageScaleType)}
		 * options.<br />
		...
		/** Sets auxiliary object which will be passed to {@link com.aristocrat.cooking.ImageLoader.core.download.ImageDownloader#getStream(String, Object)} */
		 ...
		 * {@link com.aristocrat.cooking.ImageLoader.core.imageaware.ImageAware image aware view} but
		...
		/**
		 * Sets custom {@link com.aristocrat.cooking.ImageLoader.core.display.BitmapDisplayer displayer} for image loading task. Default value -
		...
		/**
		 * Sets custom {@linkplain Handler handler} for displaying images and firing {@linkplain com.aristocrat.cooking.ImageLoader.core.listener.ImageLoadingListener
		 * listener} events.
		 */
		...
		/** Builds configured {@link com.aristocrat.cooking.ImageLoader.core.DisplayImageOptions} object */
	 ...
	 * <li>{@link com.aristocrat.cooking.ImageLoader.core.assist.ImageScaleType#IN_SAMPLE_POWER_OF_2} decoding type will be used</li>
	 * <li>{@link Bitmap.Config#ARGB_8888} bitmap config will be used for image decoding</li>
	 * <li>{@link com.aristocrat.cooking.ImageLoader.core.display.SimpleBitmapDisplayer} will be used for image displaying</li>
	 * </ul>
	 * <p/>
