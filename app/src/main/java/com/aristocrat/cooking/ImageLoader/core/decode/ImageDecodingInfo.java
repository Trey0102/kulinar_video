 ...
 *******************************************************************************/
package com.aristocrat.cooking.ImageLoader.core.decode;
...
public class ImageDecodingInfo {
	...
	/** @return Original {@linkplain com.aristocrat.cooking.ImageLoader.utils.MemoryCacheUtils#generateKey(String, com.aristocrat.cooking.ImageLoader.core.assist.ImageSize) image key} (used in memory cache). */
	...
	/**
	 * @return Target size for image. Decoded bitmap should close to this size according to {@linkplain com.aristocrat.cooking.ImageLoader.core.assist.ImageScaleType
	 * image scale type} and {@linkplain com.aristocrat.cooking.ImageLoader.core.assist.ViewScaleType view scale type}.
	 */
	...
	/**
	 * @return {@linkplain com.aristocrat.cooking.ImageLoader.core.assist.ImageScaleType Scale type for image sampling and scaling}. This parameter affects result size
	 * of decoded bitmap.
	 */
	...
	/** @return {@linkplain com.aristocrat.cooking.ImageLoader.core.assist.ViewScaleType View scale type}. This parameter affects result size of decoded bitmap. */
