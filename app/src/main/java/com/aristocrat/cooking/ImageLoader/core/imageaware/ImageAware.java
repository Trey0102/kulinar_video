 ...
 *******************************************************************************/
package com.aristocrat.cooking.ImageLoader.core.imageaware;
 ...
 * through {@link com.aristocrat.cooking.ImageLoader.core.ImageLoader ImageLoader}.
 * It can wrap any Android {@link View View} which can be accessed by {@link #getWrappedView()}. Wrapped
 * view is returned in {@link com.aristocrat.cooking.ImageLoader.core.listener.ImageLoadingListener ImageLoadingListener}'s
 * callbacks.
 *
 * @author Sergey Tarasevich (nostra13[at]gmail[dot]com)
 * @see com.aristocrat.cooking.ImageLoader.core.imageaware.ViewAware
 * @see com.aristocrat.cooking.ImageLoader.core.imageaware.ImageViewAware
 * @see com.aristocrat.cooking.ImageLoader.core.imageaware.NonViewAware
 * @since 1.9.0
 */
public interface ImageAware {
	...
	/**
	 * Returns {@linkplain com.aristocrat.cooking.ImageLoader.core.assist.ViewScaleType scale type} which is used for
	 ...
	 * {@link com.aristocrat.cooking.ImageLoader.core.listener.ImageLoadingListener#onLoadingCancelled(String,
	 ...
	 * {@linkplain com.aristocrat.cooking.ImageLoader.core.DisplayImageOptions.Builder#showImageForEmptyUri(
	 *Drawable) for empty Uri},
	 * {@linkplain com.aristocrat.cooking.ImageLoader.core.DisplayImageOptions.Builder#showImageOnLoading(
	 *Drawable) on loading} or
	 * {@linkplain com.aristocrat.cooking.ImageLoader.core.DisplayImageOptions.Builder#showImageOnFail(
	 *Drawable) on loading fail}. These drawables can be specified in
	 * {@linkplain com.aristocrat.cooking.ImageLoader.core.DisplayImageOptions display options}.<br />
	 * Also can be called in {@link com.aristocrat.cooking.ImageLoader.core.display.BitmapDisplayer BitmapDisplayer}.< br />
	 * Is called on UI thread if ImageLoader was called on UI thread. Otherwise - on background thread.
	 *
	 ...
	 * {@link com.aristocrat.cooking.ImageLoader.core.display.BitmapDisplayer BitmapDisplayer}.< br />
	 * Is called on UI thread if ImageLoader was called on UI thread. Otherwise - on background thread.
	 *
