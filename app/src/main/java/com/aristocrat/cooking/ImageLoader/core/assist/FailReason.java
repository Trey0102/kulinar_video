 ...
 *******************************************************************************/
package com.aristocrat.cooking.ImageLoader.core.assist;
...
public class FailReason {
	...
	public static enum FailType {
		...
		DECODING_ERROR,
		/**
		 * {@linkplain com.aristocrat.cooking.ImageLoader.core.ImageLoader#denyNetworkDownloads(boolean) Network
